...
const translations: Record<Language, Record<string, string>> = {
  EN: {
    ...
    hero_desc: 'Discover curated collections of timeless gold and diamond jewelry designed to complement your elegance.',
    ...
    heritage_desc1: 'Born from a lineage of Georgian master jewelers, Velluto blends ancestral gold-smithing techniques with contemporary high-fashion geometry. Every piece is hand-carved in our Tbilisi workshop using ethically sourced 18k gold and VS1 diamonds.',
    heritage_desc2: 'We believe jewelry is not an accessory, but a physical extension of your character. A silent dialogue between form, precious metal, and light.',
    stats_years: '12+',
    ...
    product_ring_desc: 'Hand-engraved 18k yellow gold signet ring featuring clean geometric facets.',
    product_bracelet_title: 'Luxury Faceted Gold Bracelet',
    product_bracelet_desc: 'Polished solid gold interlocking links, structured to catch the light at every angle.',
    product_earrings_title: 'Diamond Halo Stud Earrings',
    product_earrings_desc: 'Brilliant-cut VS1 diamonds claw-set in an architectural 18k white gold housing.',
    ...
    visit_us_desc: 'Our showroom is nestled in the historic district of Tbilisi. Experience the collections in person, receive custom sizing consultations, and preview unreleased collections.',
    ...
    // Footer
    footer_desc: 'Exclusive handcrafted jewelry and premium accessories designed to elevate your personal style. Created with luxury materials and meticulous craftsmanship.',
    ...
    notes_placeholder: 'E.g., Ring size 17, custom engraving details...',
  ...
  GE: {
    ...
    hero_desc: 'აღმოაჩინეთ მარადიული ოქროსა და ბრილიანტის სამკაულების დახვეწილი კოლექციები, რომლებიც ხაზს უსვამს თქვენს ელეგანტურობას.',
    ...
    heritage_desc1: 'ქართველი მეოქრემასწავლებლების ხაზიდან წამოსული Velluto აერთიანებს ოქრომჭედლობის საგვარეულო ტექნიკასა და თანამედროვე მაღალი მოდის გეომეტრიას. თითოეული ნამუშევარი იქმნება ჩვენს თბილისის სახელოსნოში, 18-კარატიანი ოქროსა და VS1 ბრილიანტების გამოყენებით.',
    heritage_desc2: 'ჩვენ გვჯერა, რომ სამკაული არ არის უბრალო აქსესუარი, არამედ თქვენი ხასიათის ფიზიკური გაგრძელებაა. მდუმარე დიალოგი ფორმას, ძვირფას ლითონსა და სინათლეს შორის.',
    stats_years: '12+',
    ...
    arrivals_subtitle: 'ჩვენი სახელოსნოს ბოლო კოლექციიდან საგულდაგულოდ შერჩეული სამკაულები',
    ...
    product_bracelet_desc: 'პრიალა მყარი ოქროს გადაჯაჭვული რგოლები, შექმნილი სინათლის იდეალურად ასარეკლად.',
    ...
    shop_look_subtitle: 'მიიტანეთ კურსორი ოქროს წერტილებთან სამკაულების დასათვალიერებლად და შესაძენად',
    ...
    visit_us_desc: 'ჩვენი შოურუმი მდებარეობს თბილისის ისტორიულ უბანში. ეწვიეთ კოლექციების პირადად დასათვალიერებლად, მიიღეთ ზომის კონსულტაცია და ექსკლუზიურად ნახეთ ახალი მოდელები.',
    ...
    // Footer
    footer_desc: 'ექსკლუზიური ხელნაკეთი სამკაულები და პრემიუმ აქსესუარები, რომლებიც შექმნილია თქვენი ინდივიდუალური სტილისთვის.',
    ...
    notes_placeholder: 'მაგ: ბეჭდის ზომა 17, გრავირების დეტალები...',
  ...
  RU: {
    ...
    hero_desc: 'Откройте для себя коллекции изысканных украшений из золота и бриллиантов, созданных подчеркнуть вашу элегантность.',
    ...
    heritage_desc1: 'Происходя из династии грузинских мастеров-ювелиров, Velluto сочетает традиционные методы золотого дела с геометрией высокой моды. Каждое изделие вырезается вручную в нашей тбилисской мастерской из золота 18k и бриллиантов VS1.',
    heritage_desc2: 'Мы верим, что ювелирные изделия — это не просто аксессуар, а физическое продолжение вашего характера. Безмолвный диалог между формой, благородным металлом и светом.',
    stats_years: '12+',
    ...
    arrivals_subtitle: 'Особые знаковые изделия из последнего выпуска нашей мастерской',
    ...
    product_ring_desc: 'Выгравированное вручную кольцо из желтого золота 18k с чистыми геометрическими гранями.',
    product_bracelet_title: 'Фактурный золотой браслет',
    product_bracelet_desc: 'Полированные звенья из цельного золота, созданные улавливать свет под любым углом.',
    ...
    visit_us_desc: 'Наш шоурум расположен в историческом районе Тбилиси. Оцените коллекции лично, получите консультацию по подбору размера и ознакомьтесь с новинками.',
    address_label: 'Адрес',
    ...
    // Footer
    footer_desc: 'Эксклюзивные ювелирные украшения ручной работы и премиальные аксессуары, созданные для выражения вашего стиля.',
    ...
    notes_placeholder: 'Например, размер кольца 17, гравировка...',
