    ...
    return (
      <AdminLayout>
        <div className="flex flex-col items-center justify-center py-40 space-y-4">
          ...
          <p className="text-xs uppercase tracking-widest font-semibold text-neutral-400">Loading Product details...</p>
        </div>
      </AdminLayout>
    );
  }
    ...
    <AdminLayout>
      <form onSubmit={handleSubmit} className="space-y-10">
        ...
        <div className="flex justify-between items-center border-b border-neutral-100 dark:border-neutral-800 pb-5">
          <div>
            <h2 className="text-2xl font-display font-bold text-neutral-900 dark:text-white">Edit Product</h2>
            <p className="text-xs text-neutral-400 mt-1 uppercase tracking-wider font-semibold">
              {isStaff ? 'Limited management mode (Update inventory only)' : `Modify metadata and taxonomy for SKU: ${formData.sku}`}
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="bg-white dark:bg-neutral-900 p-6 rounded-2xl border border-neutral-200 dark:border-neutral-800 shadow-sm space-y-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <input type="text" name="name" required disabled={isStaff} value={formData.name} onChange={handleChange} className="w-full text-xs border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 px-3 py-2.5 rounded-lg focus:outline-none text-neutral-900 dark:text-white disabled:bg-neutral-100 dark:disabled:bg-neutral-800" />
                </div>
                <div>
                  <label className="block text-[9px] font-bold uppercase tracking-wider text-neutral-500 mb-1.5">Product Name (KA) *</label>
                  <input type="text" name="nameKa" required disabled={isStaff} value={formData.nameKa} onChange={handleChange} className="w-full text-xs border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 px-3 py-2.5 rounded-lg focus:outline-none text-neutral-900 dark:text-white disabled:bg-neutral-100 dark:disabled:bg-neutral-800" />
                </div>
                <div>
                  <label className="block text-[9px] font-bold uppercase tracking-wider text-neutral-500 mb-1.5">Product Name (RU) *</label>
                  <input type="text" name="nameRu" required disabled={isStaff} value={formData.nameRu} onChange={handleChange} className="w-full text-xs border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 px-3 py-2.5 rounded-lg focus:outline-none text-neutral-900 dark:text-white disabled:bg-neutral-100 dark:disabled:bg-neutral-800" />
                </div>
              </div>
              ...
              <div className="space-y-4 pt-2">
                <div>
                  ...
                  <textarea name="description" disabled={isStaff} value={formData.description} onChange={handleChange} rows={3} className="w-full text-xs border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 px-3 py-2.5 rounded-lg focus:outline-none text-neutral-900 dark:text-white resize-none disabled:bg-neutral-100 dark:disabled:bg-neutral-800" />
                </div>
                <div>
                  <label className="block text-[9px] font-bold uppercase tracking-wider text-neutral-500 mb-1.5">Description (KA)</label>
                  <textarea name="descriptionKa" disabled={isStaff} value={formData.descriptionKa} onChange={handleChange} rows={3} className="w-full text-xs border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 px-3 py-2.5 rounded-lg focus:outline-none text-neutral-900 dark:text-white resize-none disabled:bg-neutral-100 dark:disabled:bg-neutral-800" />
                </div>
                <div>
                  <label className="block text-[9px] font-bold uppercase tracking-wider text-neutral-500 mb-1.5">Description (RU)</label>
                  <textarea name="descriptionRu" disabled={isStaff} value={formData.descriptionRu} onChange={handleChange} rows={3} className="w-full text-xs border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 px-3 py-2.5 rounded-lg focus:outline-none text-neutral-900 dark:text-white resize-none disabled:bg-neutral-100 dark:disabled:bg-neutral-800" />
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-neutral-900 p-6 rounded-2xl border border-neutral-200 dark:border-neutral-800 shadow-sm space-y-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <input type="number" required min="1" disabled={isStaff} name="price" value={formData.price || ''} onChange={handleChange} className="w-full text-xs border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 px-3 py-2.5 rounded-lg focus:outline-none text-neutral-900 dark:text-white disabled:bg-neutral-100 dark:disabled:bg-neutral-800" />
                </div>
                <div>
                  <label className="block text-[9px] font-bold uppercase tracking-wider text-neutral-500 mb-1.5">SKU Code *</label>
                  <input type="text" required disabled={isStaff} name="sku" value={formData.sku} onChange={handleChange} className="w-full text-xs border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 px-3 py-2.5 rounded-lg focus:outline-none text-neutral-900 dark:text-white disabled:bg-neutral-100 dark:disabled:bg-neutral-800" />
                </div>
                <div>
                  <label className="block text-[9px] font-bold uppercase tracking-wider text-neutral-500 mb-1.5">Inventory Stock level</label>
                  <input type="number" min="0" name="inventory" value={formData.inventory} onChange={handleChange} className="w-full text-xs border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 px-3 py-2.5 rounded-lg focus:outline-none text-neutral-900 dark:text-white" />
                </div>
              </div>
            </div>
                    ...
                    <div key={idx} className="p-4 bg-neutral-50 dark:bg-neutral-950 rounded-xl border border-neutral-150 dark:border-neutral-800 flex flex-col md:flex-row gap-4 items-stretch md:items-end justify-between">
                      <div className="grid grid-cols-2 md:grid-cols-5 gap-3 flex-1">
                        <div>
                          ...
                          <input type="text" required disabled={isStaff} value={variant.sku} onChange={(e) => handleVariantChange(idx, 'sku', e.target.value)} className="w-full text-xs border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 px-2.5 py-1.5 rounded focus:outline-none disabled:bg-neutral-100 dark:disabled:bg-neutral-800" />
                        </div>
                        <div>
                          <label className="block text-[8px] font-bold uppercase tracking-wider text-neutral-400 mb-1">Size</label>
                          <input type="text" disabled={isStaff} value={variant.size} placeholder="e.g. 17" onChange={(e) => handleVariantChange(idx, 'size', e.target.value)} className="w-full text-xs border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 px-2.5 py-1.5 rounded focus:outline-none disabled:bg-neutral-100 dark:disabled:bg-neutral-800" />
                        </div>
                        <div>
                          <label className="block text-[8px] font-bold uppercase tracking-wider text-neutral-400 mb-1">Metal</label>
                          <input type="text" disabled={isStaff} value={variant.metal} placeholder="e.g. Yellow Gold" onChange={(e) => handleVariantChange(idx, 'metal', e.target.value)} className="w-full text-xs border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 px-2.5 py-1.5 rounded focus:outline-none disabled:bg-neutral-100 dark:disabled:bg-neutral-800" />
                        </div>
                        <div>
                        ...
                        <div>
                          ...
                          <input type="number" disabled={isStaff} value={variant.priceAdjustment} placeholder="e.g. 50" onChange={(e) => handleVariantChange(idx, 'priceAdjustment', Number(e.target.value))} className="w-full text-xs border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 px-2.5 py-1.5 rounded focus:outline-none disabled:bg-neutral-100 dark:disabled:bg-neutral-800" />
                        </div>
                      </div>
                      {!isStaff && (
                        <button
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="bg-white dark:bg-neutral-900 p-6 rounded-2xl border border-neutral-200 dark:border-neutral-800 shadow-sm space-y-4">
              ...
              <div>
                <label className="block text-[9px] font-bold uppercase tracking-wider text-neutral-500 mb-1.5">Product ID</label>
                <input type="text" disabled value={formData.id} className="w-full text-xs border border-neutral-200 dark:border-neutral-800 bg-neutral-100 dark:bg-neutral-800 px-3 py-2.5 rounded-lg focus:outline-none text-neutral-500 cursor-not-allowed" />
              </div>

              <div>
                <label className="block text-[9px] font-bold uppercase tracking-wider text-neutral-500 mb-1.5">Store Category *</label>
                <select name="categoryId" required disabled={isStaff} value={formData.categoryId} onChange={handleChange} className="w-full text-xs border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 px-3 py-2.5 rounded-lg focus:outline-none disabled:bg-neutral-100 dark:disabled:bg-neutral-800">
                  {categories.map(c => (
              ...
              <div>
                ...
                <select name="status" disabled={isStaff} value={formData.status} onChange={handleChange} className="w-full text-xs border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 px-3 py-2.5 rounded-lg focus:outline-none disabled:bg-neutral-100 dark:disabled:bg-neutral-800">
              ...
              <div>
                ...
                <input type="text" name="tag" disabled={isStaff} value={formData.tag} onChange={handleChange} placeholder="e.g. New, Limited, Popular" className="w-full text-xs border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 px-3 py-2.5 rounded-lg focus:outline-none disabled:bg-neutral-100 dark:disabled:bg-neutral-800" />
              </div>

              <div>
                <label className="block text-[9px] font-bold uppercase tracking-wider text-neutral-500 mb-1.5">Initial Star Rating</label>
                <select name="rating" disabled={isStaff} value={formData.rating} onChange={handleChange} className="w-full text-xs border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 px-3 py-2.5 rounded-lg focus:outline-none disabled:bg-neutral-100 dark:disabled:bg-neutral-800">
                  {[5, 4, 3, 2, 1].map(r => (
            ...
            <div className="bg-white dark:bg-neutral-900 p-6 rounded-2xl border border-neutral-200 dark:border-neutral-800 shadow-sm space-y-4">
              ...
              <div>
                ...
                <input type="text" name="seoTitle" disabled={isStaff} value={formData.seoTitle} onChange={handleChange} placeholder="Custom Google title tag..." className="w-full text-xs border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 px-3 py-2.5 rounded-lg focus:outline-none disabled:bg-neutral-100 dark:disabled:bg-neutral-800" />
              </div>

              <div>
                <label className="block text-[9px] font-bold uppercase tracking-wider text-neutral-500 mb-1.5">SEO Meta Description</label>
                <textarea name="seoDescription" disabled={isStaff} value={formData.seoDescription} onChange={handleChange} rows={3} placeholder="Google description snippet..." className="w-full text-xs border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 px-3 py-2.5 rounded-lg focus:outline-none resize-none disabled:bg-neutral-100 dark:disabled:bg-neutral-800" />
              </div>
            </div>
