    ...
    <div className="min-h-screen bg-white text-neutral-900 font-sans">
      ...
      <header className="border-b border-neutral-100 py-6">
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          <Link
            href="/"
            className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-neutral-500 hover:text-neutral-900 transition-colors"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-7 space-y-8">
            <div>
              ...
              <p className="text-sm font-light text-neutral-500 mt-2">{t('checkout_subtitle')}</p>
            </div>
          ...
          <div className="lg:col-span-5 bg-neutral-50 rounded-3xl p-8 border border-neutral-100 h-fit space-y-6">
            ...
            {cart.length === 0 ? (
              <div className="py-12 text-center text-neutral-500 text-sm space-y-4">
                ...
                <Link
                  href="/"
                  className="inline-block text-xs font-semibold uppercase tracking-wider bg-neutral-900 text-white px-6 py-2.5 rounded-full hover:bg-neutral-800 transition-colors"
                >
                  {t('back_to_shop')}
                </Link>
              </div>
